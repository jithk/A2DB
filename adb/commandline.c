...
void version(FILE * out) {
    fprintf(out, "a2db - Advanced ADB by jvk...\n");
...
#if 0
int flash_rom(transport_type transport, char* serial, int argc, char** argv)
{
    ...
    if (rom_name_arg < 0) {
        ...
        return 1;
    } else if (rom_name_arg + 1 < argc) {
        fprintf(stderr, "too many files specified; Can only flash one file at a time\n");
        return 1;
    }
